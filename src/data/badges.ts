...
const BADGES: Badge[] = [
  ...
  { id: 'sourcier-de-l-espace', title: 'Sourcier de l’espace', hint: 'Réussis le quiz sur l’eau dans le système solaire.' },
  { id: 'guetteur-de-panaches', title: 'Guetteur de panaches', hint: 'Découvre Io, Encelade et Triton.' },
  { id: 'oreille-interstellaire', title: 'Oreille interstellaire', hint: 'Retrouve ʻOumuamua, le visiteur d’un autre système.' },
